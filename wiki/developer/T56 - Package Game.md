...
2. **GameLogic:** Defines game concepts such as matches, rounds, and turns. Provides methods to create, play, and end a game.
...
3. **TurnBasedGameLogic:** Extends GameLogic and provides a ready-made implementation managing turn transitions and victory/defeat conditions while maintaining a consistent game state.
...
After selecting game parameters (class and robot), the system sends the information to the backend, which creates the game and stores its details.
