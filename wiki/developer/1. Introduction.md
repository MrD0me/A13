...
3. **T1** communicates with a **MySQL** database to manage file paths for the Java classes uploaded for testing and
...
| T1          | Spring Boot (Java)     | Thymeleaf, HTML, CSS, JS | MySQL      |
